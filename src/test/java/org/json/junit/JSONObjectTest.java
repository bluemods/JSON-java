...
public class JSONObjectTest {
	...
	/**
	 * JSONObject built from a bean, but only using a null value. Nothing good is
	 * expected to happen. Expects NullPointerException
	 */
	...
	/**
	 * The JSON parser is permissive of unambiguous unquoted keys and values. Such
	 * JSON text should be allowed, even if it does not strictly conform to the
	 * spec. However, after being parsed, toString() should emit strictly conforming
	 * JSON text.
	 */
	@Test
	...
	public void testLongFromString() {
		...
		assert Long.valueOf(26315000000253009L).equals(actualLongObject)
				: "Incorrect key value. Got " + actualLongObject + " expected " + str;
	...
	/**
	 * A JSONObject can be created from another JSONObject plus a list of names. In
	 * this test, some of the starting JSONObject keys are not in the names list.
	 */
	@Test
	...
	/**
	 * JSONObjects can be built from a Map<String, Object>. In this test the map is
	...
	/**
	 * JSONObjects can be built from a Map<String, Object>. In this test all of the
	...
	public void verifyConstructor() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jaRaw, jaStrObj, jaStrInt, jaObjObj)));
	}
	...
	public void verifyPutCollection() {
		...
		Collection<Object> myCObj = Collections.singleton((Object) Integer.valueOf(10));
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jaRaw, jaObj, jaInt)));
	}
	...
	public void verifyPutMap() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jaRaw, jaStrObj, jaStrInt, jaStrObj)));
	}
	...
	/**
	 * JSONObjects can be built from a Map<String, Object>. In this test one of the
	 * map values is null
	 */
	@Test
	...
	public void bigNumberOperations() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jsonObject0, jsonObject1, jsonObject2,
	...
	public void jsonObjectIncrement() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jsonObject, inc)));
	}
	...
	public void jsonObjectPut() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jsonObject, expectedJsonObject,
	...
	public void jsonObjectToStringIndent() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jsonObject, jo)));
	}
...
//                    e.getMessage());
	...
	public void jsonObjectputNull() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jsonObjectRemove, jsonObjectPutNull)));
	}
...
//        assertTrue("should convert null to empty string", "".equals(string));
		 ...
		 * anything else, then JSONObject.NULL will be emitted as <key>null</key> and
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(jsonObjectJONull, jsonObjectNull)));
	}
	...
	/**
	 * Test to verify <code>key</code> limitations in the JSONObject bean
	 * serializer.
	 */
	@Test
	...
	public void testRepeatObjectNotRecursive() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(j0, j1, j2)));
	}
	...
	public void testLongRepeatObjectNotRecursive() {
		...
		Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(j0, j1, j2, j3, j4)));
	}
